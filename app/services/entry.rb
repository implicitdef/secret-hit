class Entry
  ...
  game_info = Core::GameInfo.new(api, ws_client, game)
  Core::Engine.signal_game_setup_done game_info
  ws_client.on_message do |ws_message|
    Core::Engine.dispatch_message game_info, ws_message
  end
